            ...
            <div className='h-[90vh] flex flex-col justify-between'>
                <nav className="my-8 text-slate-200 flex flex-col gap-3 w-full">
                    <div className='flex flex-col gap-3 text-black dark:text-slate-50 w-full'>
                        ...
                        <Button className="space-x-2 ml-2" variant="ghost">
                            <Archive />
                            <span>My Files</span>
                        </Button>
                    ...
                    <Button className='border-y-2 py-3 w-full text-center text-black dark:text-slate-50 text-base space-x-2' variant="ghost">
                        <Trash2 />
                        <span>Trash Bin</span>
                    </Button>
                </nav>
